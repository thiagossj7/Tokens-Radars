...
**Support the project:** [![ko-fi](https://img.shields.io/badge/Ko--fi-F16061?logo=ko-fi&logoColor=white)](https://ko-fi.com/kodevo)
...
- ⚠ shown when any bar exceeds 100 %
- Color-coded: green (< 80 %), yellow (≥ 80 %), red (≥ 100 %)
...
When a bar reaches ≥ 90 %, a visual alert triggers:
...
1. Open VS Code — the extension starts automatically
...
- The `anthropic-ratelimit-unified-*` headers are **unofficial** — discovered through reverse engineering of Claude Code's OAuth protocol. They may change or disappear without notice. Reference: [claude-rate-monitor](https://github.com/nsanden/claude-rate-monitor)
